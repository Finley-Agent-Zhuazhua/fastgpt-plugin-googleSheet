...
import type {
  ...
  GoogleSheetsDateTimeRenderOption,
  GoogleSheetsInsertDataOption,
  GoogleSheetsMajorDimension,
  GoogleSheetsUpdateResponse,
  GoogleSheetsValueInputOption,
  GoogleSheetsValueRenderOption,
  GoogleSheetsValues,
...
export class GoogleSheetsClient {
  ...
  async getValues(input: {
    ...
    range: string;
    majorDimension?: GoogleSheetsMajorDimension | null | undefined;
    valueRenderOption?: GoogleSheetsValueRenderOption | null | undefined;
    dateTimeRenderOption?: GoogleSheetsDateTimeRenderOption | null | undefined;
  ...
  async updateValues(input: {
    ...
    majorDimension?: GoogleSheetsMajorDimension | null | undefined;
    valueInputOption?: GoogleSheetsValueInputOption | null | undefined;
  ...
  async appendValues(input: {
    ...
    majorDimension?: GoogleSheetsMajorDimension | null | undefined;
    valueInputOption?: GoogleSheetsValueInputOption | null | undefined;
    insertDataOption?: GoogleSheetsInsertDataOption | null | undefined;
...
export function createGoogleSheetsClient(
  ...
  return new GoogleSheetsClient(serviceAccountJson, options);
}
...
export function normalizeValues(value: unknown): GoogleSheetsValues {
  ...
  return value.map((row) => {
    if (!Array.isArray(row) || row.length === 0) {
      throw new Error("each values row must be a non-empty array");
    }
...
export function clearGoogleSheetsTokenCacheForTests(): void {
  tokenCache.clear();
}
